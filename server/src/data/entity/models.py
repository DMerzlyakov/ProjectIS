...
def update_base():
    data_for_projects = [{'owner': 'Давид', 'manager': 'Данила', 'startDate': datetime.datetime.utcnow(),
                          'endDate': datetime.datetime.utcnow(), 'title': 'Разработка', 'price': 20000,
                          'status': 'В работе'},
                         {'owner': 'Даша', 'manager': 'Никита', 'startDate': datetime.datetime.utcnow(),
                          'endDate': datetime.datetime.utcnow(), 'title': 'Python-разработка', 'price': 500000,
                          'status': 'Завершено'}]
    ...
    data_for_vacancies = [{'type': 'Python-developer', 'role_id': 1, 'skill_id': 1},
                          {'type': 'java-developer', 'role_id': 2, 'skill_id': 2}]
